export const sectionsTestIds = {
  ...
  EXPENSES_SECTION: 'expenses_section',
  MY_CATEGORIES_SECTION: 'my_categories_section',
...
export const elementTestIds = {
  ADD_POPUP_TRANSACTION_BTN_ELEMENT: 'add_transaction_btn_element',
  ADD_FORM_TRANSACTION_BTN_ELEMENT: 'add_form_transaction_btn_element',
  TRANSACTION_FORM_ELEMENT: 'transaction_form_element',
  TITLE_TRANSACTION_INPUT_ELEMENT: 'title_transaction_input_element',
  DESCRIPTION_TRANSACTION_INPUT_ELEMENT:
    'description_transaction_input_element',
  PRICE_TRANSACTION_INPUT_ELEMENT: 'price_transaction_input_element',
  CATEGORY_TRANSACTION_SELECT_ELEMENT: 'category_transaction_select_element',
  CATEGORY_TRANSACTION_SELECTLIST_ELEMENT:
    'category_transaction_selectlist_element',
