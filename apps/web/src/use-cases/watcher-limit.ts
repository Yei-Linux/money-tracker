import { expenseLimitEmailTemplate } from '@moneytrack/web/constants/templates';
import { getSettingsMoneyAccount } from './money-account';
import userModel from '@moneytrack/web/models/auth/user.model';
import { sendGridProxy } from '@moneytrack/web/lib/send-grid';
import { WATCHER_LIMIT_SUBJECTS } from '@moneytrack/web/constants/watcher-limit';
import { getAllUsersBy } from '@moneytrack/web/repository/users';
